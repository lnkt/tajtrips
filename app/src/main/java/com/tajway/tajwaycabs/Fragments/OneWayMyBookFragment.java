...
public class OneWayMyBookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_one_way_my_book, container, false);
    ...
    private void MyBookingApi() {
        ...
        if (CommonUtils.isOnline(getActivity())) {
            ...
            Call<MyBookingModel> call = ApiExecutor.getApiService(getActivity()).apiMyBookingList("Bearer " + sessonManager.getToken(), "onewaytrip");
