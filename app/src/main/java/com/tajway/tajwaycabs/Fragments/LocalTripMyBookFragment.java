...
public class LocalTripMyBookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null){
            view = inflater.inflate(R.layout.fragment_local_trip_my_book, container, false);
...
Log.e("MyBookingApi","Bearer " + sessonManager.getToken());
        if (CommonUtils.isOnline(getActivity())) {
            final ProgressDialog dialog = ProgressDialog.show(getActivity(), null, getString(R.string.loading));

            Call<MyBookingModel> call = ApiExecutor.getApiService(getActivity()).apiMyBookingList("Bearer " + sessonManager.getToken(),"localtrip");
