...
public class OneWayRejectBooking_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null){
            view = inflater.inflate(R.layout.fragment_one_way_rejected_booking, container, false);
    ...
    private void RejectBookApi() {

        if (CommonUtils.isOnline(getActivity())) {
            final ProgressDialog dialog = ProgressDialog.show(getActivity(), null, getString(R.string.loading));

            Call<MyBookingModel> call = ApiExecutor.getApiService(getActivity()).apiRejectBookingList("Bearer " + sessonManager.getToken(),"onewaytrip");
