...
public class LocalTrip_Reject_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null){
            view = inflater.inflate(R.layout.fragment_reject_local_trip, container, false);
    ...
    private void RejectLocalTripApi() {

        if (CommonUtils.isOnline(getActivity())) {
            final ProgressDialog dialog = ProgressDialog.show(getActivity(), null, getString(R.string.loading));

            Call<MyBookingModel> call = ApiExecutor.getApiService(getActivity()).apiRejectBookingList("Bearer " + sessonManager.getToken(),"localtrip");
