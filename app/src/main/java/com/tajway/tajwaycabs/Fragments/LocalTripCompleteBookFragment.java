...
public class LocalTripCompleteBookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_local_trip_complete_book, container, false);
    ...
    private void CompleteApi() {
        Log.e("CompleteApi", "sessonManager.getToken()--" + sessonManager.getToken());
        if (CommonUtils.isOnline(getActivity())) {
            final ProgressDialog dialog = ProgressDialog.show(getActivity(), null, getString(R.string.loading));

            Call<MyBookingModel> call = ApiExecutor.getApiService(getActivity()).apiCompleteBookingList("Bearer " + sessonManager.getToken(), "localtrip");
    ...
    public class MyBookAdapter extends RecyclerView.Adapter<MyBookAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            TextView tv_trip_id_one_way, tv_trip_type_one_way, tv_car_type_one_way, tv_total_kms_one_way, tv_total_hours_one_way,
                    ...
                    tv_remark_one_way, TvAccept, tv_end_date_one_way;
