...
public class RoundTripCompleteBookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_round_trip_complete_book, container, false);
    ...
    private void CompleteApi() {
        ...
        if (CommonUtils.isOnline(getActivity())) {
            ...
            Call<MyBookingModel> call = ApiExecutor.getApiService(getActivity()).apiCompleteBookingList("Bearer " + sessonManager.getToken(), "roundtrip");
