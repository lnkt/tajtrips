...
public class RejectBookingTab_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reject_booking_tab_);
       ...
       MyAdapter adapter = new MyAdapter(this,getSupportFragmentManager(),
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                Log.d("hhdhhhd", String.valueOf(tab.getPosition()));

                String name = tab.getBadge().toString();


                Log.d("hsgysgfhf", name);
            }
            @Override
