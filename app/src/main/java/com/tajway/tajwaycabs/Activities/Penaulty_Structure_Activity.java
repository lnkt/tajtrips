...
public class Penaulty_Structure_Activity extends AppCompatActivity {
   ...
   /* @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_penaulty__structure_, container, false);*/

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_penaulty__structure_);
        getSupportActionBar().setTitle("Penalty Structure");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    

    rvInfo = findViewById(R.id.rvInfo);
        sessonManager = new SessonManager(Penaulty_Structure_Activity.this);
    ...
    private void hitApi() {
        ...
        if (CommonUtils.isOnline(Penaulty_Structure_Activity.this)) {
            final ProgressDialog dialog = ProgressDialog.show(Penaulty_Structure_Activity.this, null, getString(R.string.loading));

            Call<InfoStatusModel> call = ApiExecutor.getApiService(Penaulty_Structure_Activity.this).apiInfoList("Bearer " + sessonManager.getToken(),"penalty");
            ...
            CommonUtils.showToastInCenter(Penaulty_Structure_Activity.this, getString(R.string.please_check_network));
        }
    }

    private void setRvData() {
        rvInfo.setAdapter(new InfoAdapter(Penaulty_Structure_Activity.this,list));
    }
