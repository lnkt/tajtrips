...
public class Information_Activity extends AppCompatActivity {
   ...
   /* @Override
    ...
    rvInfo = findViewById(R.id.rvInfo);
        sessonManager = new SessonManager(Information_Activity.this);
    ...
    private void hitApi() {
        ...
        if (CommonUtils.isOnline(Information_Activity.this)) {
            final ProgressDialog dialog = ProgressDialog.show(Information_Activity.this, null, getString(R.string.loading));

            Call<InfoStatusModel> call = ApiExecutor.getApiService(Information_Activity.this).apiInfoList("Bearer " + sessonManager.getToken(),"information");
            ...
            CommonUtils.showToastInCenter(Information_Activity.this, getString(R.string.please_check_network));
        }
    }

    private void setRvData() {
        rvInfo.setAdapter(new InfoAdapter(Information_Activity.this,list));
    }
